...
) const
{
	...
	{
		Controller->AddRetargetPose(Mesh->GetFName(), nullptr, ERetargetSourceOrTarget::Target);
...
UIKRigDefinition* FMixamoSkeletonRetargeter::CreateMixamoIKRig(const USkeleton* Skeleton) const
{
	...
	Controller->AddRetargetChain(FBoneChain(TEXT("Root"), TEXT("root"), TEXT("root")));
	Controller->AddRetargetChain(FBoneChain(TEXT("Spine"), TEXT("Spine"), TEXT("Spine2")));
	Controller->AddRetargetChain(FBoneChain(TEXT("Head"), TEXT("Neck"), TEXT("head")));
	static const FName LeftClavicleChainName(TEXT("LeftClavicle"));
	Controller->AddRetargetChain(FBoneChain(LeftClavicleChainName, TEXT("LeftShoulder"), TEXT("LeftShoulder")));
	static const FName LeftArmChainName(TEXT("LeftArm"));
	static const FName LeftHandBoneName(TEXT("LeftHand"));
	Controller->AddRetargetChain(FBoneChain(LeftArmChainName, TEXT("LeftArm"), LeftHandBoneName));
	static const FName RightClavicleChainName(TEXT("RightClavicle"));
	Controller->AddRetargetChain(FBoneChain(RightClavicleChainName, TEXT("RightShoulder"), TEXT("RightShoulder")));
	static const FName RightArmChainName(TEXT("RightArm"));
	static const FName RightHandBoneName(TEXT("RightHand"));
	Controller->AddRetargetChain(FBoneChain(RightArmChainName, TEXT("RightArm"), RightHandBoneName));
	static const FName LeftLegChainName(TEXT("LeftLeg"));
	static const FName LeftToeBaseBoneName(TEXT("LeftToeBase"));
	Controller->AddRetargetChain(FBoneChain(LeftLegChainName, TEXT("LeftUpLeg"), LeftToeBaseBoneName));
	static const FName RightLegChainName(TEXT("RightLeg"));
	static const FName RightToeBaseBoneName(TEXT("RightToeBase"));
	Controller->AddRetargetChain(FBoneChain(RightLegChainName, TEXT("RightUpLeg"), RightToeBaseBoneName));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftIndex"), TEXT("LeftHandIndex1"), TEXT("LeftHandIndex3")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightIndex"), TEXT("RightHandIndex1"), TEXT("RightHandIndex3")));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftMiddle"), TEXT("LeftHandMiddle1"), TEXT("LeftHandMiddle3")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightMiddle"), TEXT("RightHandMiddle1"), TEXT("RightHandMiddle3")));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftPinky"), TEXT("LeftHandPinky1"), TEXT("LeftHandPinky3")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightPinky"), TEXT("RightHandPinky1"), TEXT("RightHandPinky3")));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftRing"), TEXT("LeftHandRing1"), TEXT("LeftHandRing3")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightRing"), TEXT("RightHandRing1"), TEXT("RightHandRing3")));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftThumb"), TEXT("LeftHandThumb1"), TEXT("LeftHandThumb3")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightThumb"), TEXT("RightHandThumb1"), TEXT("RightHandThumb3")));
	...
	{
		Controller->AddRetargetChain(FBoneChain(/*ChainName=*/BoneName, /*StartBoneName=*/BoneName, /*EndBoneName=*/BoneName));
	}
...
) const
{
	...
	Controller->AddRetargetChain(FBoneChain(TEXT("Root"), TEXT("root"), TEXT("root")));
	Controller->AddRetargetChain(FBoneChain(TEXT("Spine"), TEXT("spine_01"), SelectBySkeletonType(SkeletonType, TEXT("spine_03"), TEXT("spine_05"))));
	Controller->AddRetargetChain(FBoneChain(TEXT("Head"), TEXT("neck_01"), TEXT("head")));
	static const FName LeftClavicleChainName(TEXT("LeftClavicle"));
	Controller->AddRetargetChain(FBoneChain(LeftClavicleChainName, TEXT("clavicle_l"), TEXT("clavicle_l")));
	static const FName LeftArmChainName(TEXT("LeftArm"));
	static const FName LeftHandBoneName(TEXT("hand_l"));
	Controller->AddRetargetChain(FBoneChain(LeftArmChainName, TEXT("upperarm_l"), LeftHandBoneName));
	static const FName RightClavicleChainName(TEXT("RightClavicle"));
	Controller->AddRetargetChain(FBoneChain(RightClavicleChainName, TEXT("clavicle_r"), TEXT("clavicle_r")));
	static const FName RightArmChainName(TEXT("RightArm"));
	static const FName RightHandBoneName(TEXT("hand_r"));
	Controller->AddRetargetChain(FBoneChain(RightArmChainName, TEXT("upperarm_r"), RightHandBoneName));
	static const FName LeftLegChainName(TEXT("LeftLeg"));
	static const FName LeftBallBoneName(TEXT("ball_l"));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftLeg"), TEXT("thigh_l"), LeftBallBoneName));
	static const FName RightLegChainName(TEXT("RightLeg"));
	static const FName RightBallBoneName(TEXT("ball_r"));
	Controller->AddRetargetChain(FBoneChain(RightLegChainName, TEXT("thigh_r"), RightBallBoneName));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftIndex"), TEXT("index_01_l"), TEXT("index_03_l")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightIndex"), TEXT("index_01_r"), TEXT("index_03_r")));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftMiddle"), TEXT("middle_01_l"), TEXT("middle_03_l")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightMiddle"), TEXT("middle_01_r"), TEXT("middle_03_r")));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftPinky"), TEXT("pinky_01_l"), TEXT("pinky_03_l")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightPinky"), TEXT("pinky_01_r"), TEXT("pinky_03_r")));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftRing"), TEXT("ring_01_l"), TEXT("ring_03_l")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightRing"), TEXT("ring_01_r"), TEXT("ring_03_r")));
	Controller->AddRetargetChain(FBoneChain(TEXT("LeftThumb"), TEXT("thumb_01_l"), TEXT("thumb_03_l")));
	Controller->AddRetargetChain(FBoneChain(TEXT("RightThumb"), TEXT("thumb_01_r"), TEXT("thumb_03_r")));
	if (bIsUE5Skeleton)
	{
		...
		Controller->AddRetargetChain(FBoneChain(TEXT("LeftIndexMetacarpal"), TEXT("index_metacarpal_l"), TEXT("index_metacarpal_l")));
		Controller->AddRetargetChain(FBoneChain(TEXT("RightIndexMetacarpal"), TEXT("index_metacarpal_r"), TEXT("index_metacarpal_r")));
		Controller->AddRetargetChain(FBoneChain(TEXT("LeftMiddleMetacarpal"), TEXT("middle_metacarpal_l"), TEXT("middle_metacarpal_l")));
		Controller->AddRetargetChain(FBoneChain(TEXT("RightMiddleMetacarpal"), TEXT("middle_metacarpal_r"), TEXT("middle_metacarpal_r")));
		Controller->AddRetargetChain(FBoneChain(TEXT("LeftPinkyMetacarpal"), TEXT("pinky_metacarpal_l"), TEXT("pinky_metacarpal_l")));
		Controller->AddRetargetChain(FBoneChain(TEXT("RightPinkyMetacarpal"), TEXT("pinky_metacarpal_r"), TEXT("pinky_metacarpal_r")));
		Controller->AddRetargetChain(FBoneChain(TEXT("LeftRingMetacarpal"), TEXT("ring_metacarpal_l"), TEXT("ring_metacarpal_l")));
		Controller->AddRetargetChain(FBoneChain(TEXT("RightRingMetacarpal"), TEXT("ring_metacarpal_r"), TEXT("ring_metacarpal_r")));
	}
